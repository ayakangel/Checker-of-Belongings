...
# Google Client ID（CLIENT_IDを定義）
CLIENT_ID = '137115175170-n02tgetvlo051kalsk5so8p5aeik3l1s.apps.googleusercontent.com'
...
"""    
    ...
    def handle_message(self,event):
        with ApiClient(configuration) as api_client:
            #ユーザーIDの取得
            #senderusid = event.source.user_id
#           pprint(senderusid)
